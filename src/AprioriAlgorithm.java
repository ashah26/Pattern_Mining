...
public class AprioriAlgorithm {
    ...
    private void configuration(String[] args) throws Exception{
        if(args.length!=0){
            ...
            min_support = 75;
            k=1;
            inputFilePath ="/home/ashna/IdeaProjects/PAttern_Mining/resource/transactionDB.txt";
            outputFilePath = "/home/ashna/IdeaProjects/PAttern_Mining/output/output.txt";
        }
    ...
    private void implementAlgorithm()throws Exception{
        //System.out.println("Implement Algortihm");
        ...
        //System.out.println("After Implement Algortihm");
    }
